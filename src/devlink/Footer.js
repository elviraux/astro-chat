...
export function Footer({ as: _Component = _Builtin.Section }) {
  return (
    <_Component
      className={_utils.cx(_styles, "footer", "inverse-footer")}
      tag="footer"
    >
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        ...
        >
          <_Builtin.Block
            className={_utils.cx(
              _styles,
              "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4b6-16fdf4b3"
            )}
            id={_utils.cx(
              _styles,
          ...
          >
            <_Builtin.Heading
              ...
              id={_utils.cx(
                _styles,
                "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4b7-16fdf4b3"
              )}
              tag="h2"
            >
          ...
          <_Builtin.Block
            className={_utils.cx(
              _styles,
              "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4bd-16fdf4b3"
            )}
            id={_utils.cx(
              _styles,
            ...
            tag="div"
          >
            <_Builtin.Block tag="div">{"555 555 5555"}</_Builtin.Block>
            <_Builtin.Link
              className={_utils.cx(
                _styles,
                "footer-link",
            ...
            >
              <_Builtin.Block tag="div">{"hello@astronum.com"}</_Builtin.Block>
            </_Builtin.Link>
          </_Builtin.Block>
          <_Builtin.List
            className={_utils.cx(
              ...
              "grid-gap-xs",
              "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4c3-16fdf4b3"
            )}
            id={_utils.cx(
              _styles,
              "w-node-_686aafad-4ad6-d604-e192-54da9351d824-9351d813"
            )}
            tag="ul"
            role="list"
            unstyled={true}
          >
            ...
            >
              ...
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "paragraph-xxl")}
                  tag="div"
                >
            ...
            >
              ...
              >
                <_Builtin.Block
                  ...
                  tag="div"
                >
                  <_Builtin.Strong>{"Features"}</_Builtin.Strong>
                </_Builtin.Block>
              </_Builtin.Link>
            </_Builtin.ListItem>
            <_Builtin.ListItem
            ...
            >
              ...
              >
                <_Builtin.Block
                  ...
                  tag="div"
                >
                  <_Builtin.Strong>{"Pricing"}</_Builtin.Strong>
                </_Builtin.Block>
              </_Builtin.Link>
            </_Builtin.ListItem>
            <_Builtin.ListItem
            ...
            >
              ...
              >
                <_Builtin.Block
                  ...
                  tag="div"
                >
                  <_Builtin.Strong>{"FAQ"}</_Builtin.Strong>
                </_Builtin.Block>
              </_Builtin.Link>
            </_Builtin.ListItem>
            <_Builtin.ListItem
            ...
            <_Builtin.ListItem
              ...
              id={_utils.cx(
                _styles,
                "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4dd-16fdf4b3"
              )}
            >
              <_Builtin.Link
                className={_utils.cx(
              ...
              >
                <_Builtin.Block
                  ...
                  tag="div"
                >
                  <_Builtin.Strong>{"Support"}</_Builtin.Strong>
                </_Builtin.Block>
              </_Builtin.Link>
            </_Builtin.ListItem>
          </_Builtin.List>
          <_Builtin.Link
            className={_utils.cx(
              ...
              "footer-link",
              "footer-link-on-inverse",
              "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4e2-16fdf4b3"
            )}
            id={_utils.cx(
              _styles,
              "w-node-_686aafad-4ad6-d604-e192-54da9351d83f-9351d813"
            )}
            button={false}
            block="inline"
            options={{
          ...
          <_Builtin.Grid
            className={_utils.cx(
              ...
              "mobile-portrait-1-column",
              "grid-gap-sm",
              "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4e5-16fdf4b3"
            )}
            id={_utils.cx(
              _styles,
          ...
          >
            <_Builtin.List
              ...
              id={_utils.cx(
                _styles,
                "w-node-_0fa15025-447c-3f9b-97fc-208416fdf4e6-16fdf4b3"
              )}
              tag="ul"
            ...
            <_Builtin.Block
              className={_utils.cx(
                ...
                "w-node-_0fa15025-447c-3f9b-97fc-208416fdf50d-16fdf4b3"
              )}
              id={_utils.cx(
                _styles,
